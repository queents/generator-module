...
class WidgetGenerator implements GeneratorInterface
{
    ...
    public function generateModelName()
    {
        ...
        $this->folderDirectory =["/Vilt","/Resources","/".$this->resourceName,"/Widgets"];
        $this->stubPath ="Resources/ModuleResource/Widgets/ModuleWidget";
        $this->targetPath =module_path($this->moduleName).  '/Vilt/Resources/' . $this->resourceName . '/Widgets/'.$this->modelName.'Widget.php';
    }
